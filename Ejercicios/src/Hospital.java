...
//Tenga en cuenta qué si el paciente es subsidiado se le realizará un descuento del 10% sobre el valor total del valor a pagar.
...
public class Hospital {
	...
	public static void main(String[] args) {
        ...
        String mensaje,subsidio,cumpleaños;
        ...
        if(subsidio=="s") {
        	...
        	cumpleaños = JOptionPane.showInputDialog("¿Usted esta cumpliendo años?, Digite s para si, n para no");
        	if(cumpleaños=="s") {
